        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <Link to="/dashboard" className="block text-sm text-[#6B7280] hover:text-[#1A1A2E] transition-colors">Dashboard</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a href="#" className="block text-sm text-[#6B7280] hover:text-[#1A1A2E] transition-colors">Careers</a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a href="#" className="block text-sm text-[#6B7280] hover:text-[#1A1A2E] transition-colors">Contact Us</a>
            </div>
          </div>
        </div>
      </div>
